...
| `storeRefreshes`                   | `Number` | The total amount of times to refresh store purchases.                                                          |   `0`   |
| `maxGold`                          | `Number` | The maximum amount of gold bounties to allow to dispatch rest. Will refresh list until this amount.            |   `1`   |
